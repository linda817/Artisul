...
$idProducto = $_GET['id'];
$info = $Producto->obtenerInfo($idProducto);
            ...
            <div class="container row">
                ...
                <div class="row col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input type="text" name="nombreProducto" id="nombreProducto" class="form-control" value="<?=$info['nombreProducto']?>">
                        </div>
                    </div>
                            ...
                            <select name="idMarca" id="idMarca" class="form-control">
                                ...
                                foreach ($listado as $item){
                                    ...
                                    <option value="<?=$item['idMarca']?>"
                                        <?=($item['idMarca'] == $info['idMarca'] ? 'selected' : ''); ?>><?=$item['nombreMarca']?></option>
                                    <?php
                                }
                                ?>
                            </select>
                            ...
                            <select name="idCategoria" id="idCategoria" class="form-control">
                                ...
                                foreach ($listado as $item){
                                    ...
                                    <option value="<?=$item['idCategoria']?>"
                                        <?=($item['idCategoria'] == $info['idCategoria'] ? 'selected' : ''); ?>><?=$item['nombreCategoria']?></option>
                                    <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <input type="text" name="descripcionProducto" id="descripcionProducto" class="form-control" value="<?=$info['descripcionProducto']?>">
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <input type="number" name="costoProducto" id="costoProducto" class="form-control" value="<?=$info['costoProducto']?>">
                        </div>
                    </div>
                            ...
                            <select name="idProveedor" id="idProveedor" class="form-control">
                                ...
                                foreach ($listado as $item) {
                                    ...
                                    <option value="<?=$item['idProveedor']?>"
                                        <?=($item['idProveedor'] == $info['idProveedor'] ? 'selected' : ''); ?>><?=$item['nombreProveedor']?></option>
                                    <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <input type="number" name="cantidadProducto" id="cantidadProducto" class="form-control" value="<?=$info['cantidadProducto']?>">
                        </div>
                    </div>
                </div>
            </div>
