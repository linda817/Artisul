...
$info = $Proveedor->obtenerInfo($idProveedor);

$selectedActivo = "";
if ($info['estadoProveedor'] == 1) {
    $selectedActivo = "selected";
}
$selectedInactivo = "";
if ($info['estadoProveedor'] == 0) {
            ...
            <form name="agregar" id="agregar" action="" method="post">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="nombreProveedor" id="nombreProveedor" class="form-control" required
                           value="<?php echo $info['nombreProveedor'] ?>">
                </div>
                ...
                <div class="form-group botones-agregar">
                    ...
                    <a href="../Proveedores/index.php" class="btn btn-dark">Cancelar</a>
                </div>
